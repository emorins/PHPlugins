...
public class PlaneReflection : MonoBehaviour {
    ...
    public LayerMask    reflectLayerMask = -17;
    ...
    public void OnWillRenderObject() {
        ...
        m_reflectionCamera.cullingMask = -405864481;
        ...
        m_reflectionCamera.projectionMatrix = m_renderCamera.CalculateObliqueMatrix(CameraSpacePlane(m_reflectionCamera, pos, normal, 1f));
        // find the reflection plane: position and normal in world space
        ...
        var reflectedDir = -ReflectVector(normal, srcCamFwd);
        m_reflectionCamera.transform.rotation = Quaternion.LookRotation(reflectedDir, srcCamUp);
       // m_reflectionCamera.nearClipPlane += planeDist;
        ...
        SetupConvolveParams(srcCamPos, srcCamRgt, srcCamUp, srcCamFwd, reflectionMatrix, normal);
...
//requires version>5.5b10:
    ...
    Camera EnsureReflectionCamera(Camera renderCamera) {
        ...
        m_reflectionCamera.useOcclusionCulling = true;
